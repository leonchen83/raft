...
import static com.moilioncircle.raft.util.Classes.getShortClassName;
import static com.moilioncircle.raft.util.Objects.cast;
import static com.moilioncircle.raft.util.Strings.delete;
...
public class ToStringBuilderStyle {
    ...
    public void append(StringBuilder b, String f, Object v, boolean d) {
        appendFieldSt(b, f);
        if (v == null) appendNull(b, f);
        else appendInternal(b, f, v, d);
        appendFieldEd(b, f);
    }
    ...
    protected void appendDetails(StringBuilder b, String f, Object[] v) {
        ...
        for (int i = 0; i < v.length; i++) {
            ...
            if (item == null) appendNull(b, f);
            else appendInternal(b, f, item, true);
        }
        b.append(ARRAY_ED);
    }
    ...
    public void append(StringBuilder b, String f, Object[] v, boolean d) {
        appendFieldSt(b, f);
        if (v == null) appendNull(b, f);
        else if (d) appendDetails(b, f, v);
        else appendSummary(b, f, v);
        appendFieldEd(b, f);
    }
